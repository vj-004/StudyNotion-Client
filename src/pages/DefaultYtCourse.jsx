...
const DefaultYtCourse = () => {
    ...
    useEffect(() => {
        ...
        const setYtCourseData = () => {
            const defaultYtCourseData = JSON.parse(localStorage.getItem("defaultYtCourseData"));
            const defaultYtCourseMetaData = JSON.parse(localStorage.getItem("defaultYtCourseMetaData"));
            const currentYtCourseIdx = defaultYtCourseData.findIndex((course) => course.playlist_id === ytPlaylistId);
            const ytCourseObj = {
                playlist: {
                    ...defaultYtCourseData[currentYtCourseIdx]
                },
                title: defaultYtCourseMetaData[currentYtCourseIdx].title,
            };
            setYtCourse(ytCourseObj);
        }
    ...
    const handleToggleComplete = async () => {
        ...
        toast.error("Please Login to mark a lecture as complete");
        return;
...
export default DefaultYtCourse;