  ...
  return (
    <div className='flex flex-col justify-center items-center p-14'>
        ...
        <div className='mx-auto gap-4 flex flex-col justify-center items-center'>
            <p className='text-4xl font-semibold font-inter text-richblack-900 text-center'>Your study toolkit for <HighlightText text={" structured YouTube courses"} gradient={"bg-gradient-to-r from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB]"}/></p>
            <p className='text-base font-inter text-richblack-700 w-[70%] text-center'>Organize playlists into sections, track completed lessons, and follow a clean learning path from the first video to the last.</p>
        </div>
        ...
        <CustomButton text={"Start Organizing"} active={true} arrow={true} dest={"/login"} />
    </div>
  )
}
