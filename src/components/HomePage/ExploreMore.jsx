...
const ExploreMore = () => {
    ...
    <div className='flex flex-col gap-5'>
        ...
        <div className='text-4xl font-semibold text-center'>
            Organize your 
            <HighlightText text={" YouTube courses"} gradient={"bg-gradient-to-r from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB]"}/>
        </div>

        <p className='text-richblack-300 text-center text-base'>Import a link, split it into lessons, and follow a clear study path.</p>
